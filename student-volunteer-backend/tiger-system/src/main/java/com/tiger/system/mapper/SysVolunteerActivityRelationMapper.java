 ...
 * @date 2024-03-24
 */
public interface SysVolunteerActivityRelationMapper extends BaseMapper<SysVolunteerActivityRelation> {
    /**
     * 查询志愿者活动关系
     *
     * @param id 志愿者活动关系主键
     ...
     * @return 结果
     */
    int insertSysVolunteerActivityRelation(SysVolunteerActivityRelation sysVolunteerActivityRelation);
